    ...
    <div className="relative w-full">
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full h-8 pl-8 pr-14 rounded-md bg-card border border-white/[0.07] text-primary placeholder-muted text-xs font-mono focus:outline-none focus:border-ae/40 focus:bg-elevated transition-colors"
        />
